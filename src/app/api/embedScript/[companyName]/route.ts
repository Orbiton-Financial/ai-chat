...
export async function GET(request: Request) {
  ...
  const presetPrompts = company.preset_prompts ?? [];

  // Convert presetPrompts to a JSON string to inject into the script
  const presetPromptsJson = JSON.stringify(presetPrompts);
  ...
  /* ---------------------------------------- */
    ...
    // Use the dynamic preset prompts passed from the server
    var presetPrompts = ${presetPromptsJson};
